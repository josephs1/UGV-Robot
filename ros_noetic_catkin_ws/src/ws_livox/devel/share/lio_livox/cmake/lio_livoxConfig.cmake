...
if(lio_livox_CONFIG_INCLUDED)
  return()
endif()
set(lio_livox_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lio_livox_SOURCE_PREFIX /home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/src/LIO-Livox)
  set(lio_livox_DEVEL_PREFIX /home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/devel)
  set(lio_livox_INSTALL_PREFIX "")
  set(lio_livox_PREFIX ${lio_livox_DEVEL_PREFIX})
else()
  set(lio_livox_SOURCE_PREFIX "")
  set(lio_livox_DEVEL_PREFIX "")
  set(lio_livox_INSTALL_PREFIX /home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/install)
  set(lio_livox_PREFIX ${lio_livox_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lio_livox' is deprecated")
...
set(lio_livox_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/src/LIO-Livox/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4 " STREQUAL " ")
  set(lio_livox_INCLUDE_DIRS "")
  set(_include_dirs "/home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/src/LIO-Livox/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lio_livox_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lio_livox' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lio_livox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/src/LIO-Livox/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lio_livox_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lio_livox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lio_livox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lio_livox_NUM_DUMMY_TARGETS)
      set(lio_livox_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lio_livox::wrapped-linker-option${lio_livox_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lio_livox_NUM_DUMMY_TARGETS "${lio_livox_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lio_livox::wrapped-linker-option${lio_livox_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lio_livox_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/devel/lib;/home/jstefan1/Documents/CodeWorkspace/UGV-Robot/ros_noetic_catkin_ws/src/ws_livox/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(lio_livox_LIBRARY_DIRS ${lib_path})
      list(APPEND lio_livox_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lio_livox'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lio_livox_LIBRARIES ${lib})
    endif()
  endif()
...
set(lio_livox_EXPORTED_TARGETS "lio_livox_generate_messages_cpp;lio_livox_generate_messages_eus;lio_livox_generate_messages_lisp;lio_livox_generate_messages_nodejs;lio_livox_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lio_livox_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;message_runtime;pcl_conversions;pcl_ros;message_filters;std_srvs;tf_conversions;tf;eigen_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lio_livox_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lio_livox_dep}_FOUND)
      find_package(${lio_livox_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lio_livox_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lio_livox_INCLUDE_DIRS ${${lio_livox_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lio_livox_LIBRARIES ${lio_livox_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lio_livox_dep}_LIBRARIES})
  _list_append_deduplicate(lio_livox_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lio_livox_LIBRARIES ${lio_livox_LIBRARIES})

  _list_append_unique(lio_livox_LIBRARY_DIRS ${${lio_livox_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(lio_livox_EXPORTED_TARGETS ${${lio_livox_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lio_livox-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lio_livox_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
